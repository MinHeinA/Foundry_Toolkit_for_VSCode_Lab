...
# PROVIDED - Import the bounded Careers MCP helper.
#
...
# SETUP CHECKPOINT - Prove the MCP connection before editing the agent.
#
...
# PROVIDED - Local and hosted configuration use the same variable names.
#
# Hint:
...
# PROVIDED GUARDRAIL - Relay the selected job key exactly.
#
# Hint:
...
# PROVIDED GUARDRAIL - Define selected-job behavior and untrusted-data handling.
#
# Hints:
...
# PROVIDED GUARDRAIL - Preserve source provenance.
#
# Hint:
...
# PROVIDED GUARDRAIL - Include provenance in the final response.
#
# Hint:
...
# untrusted data. Do not add search or send resume content to this tool.
@tool
...
def main() -> None:
    ...
    # TODO 2 - Give the Careers tool only to JobDescriptionAgent.
    #
    # Add get_selected_careers_job to this agent's tools list.
    ...
    # PROVIDED GUARDRAIL - Preserve every relay boundary and stop failed lookups.
    #
    # Hint:
