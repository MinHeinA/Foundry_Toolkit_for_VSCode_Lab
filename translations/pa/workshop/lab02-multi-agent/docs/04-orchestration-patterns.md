...
ਪੂਰਾ `create_workflow()` ਫੰਕਸ਼ਨ [`PersonalCareerCopilotCompleted/main.py`](../../../../../workshop/lab02-multi-agent/PersonalCareerCopilotCompleted/main.py) ਵਿੱਚ ਹੈ। ਤਿੰਨ `add_edge()` ਕਾਲ ਲੜੀਵਾਰ ਪਾਈਪਲਾਈਨ ਬਣਾਉਂਦੀਆਂ ਹਨ:
