...
पूरा `create_workflow()` फङ्सन [`PersonalCareerCopilotCompleted/main.py`](../../../../../workshop/lab02-multi-agent/PersonalCareerCopilotCompleted/main.py) मा छ। तीनवटा `add_edge()` कलहरूले अनुक्रमिक पाइपलाइन बनाउँछन्:
